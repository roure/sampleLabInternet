package cat.tecnocampus.sample.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, cat.tecnocampus.sample.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, cat.tecnocampus.sample.repository.UserRepository.USERS_BY_EMAIL_CACHE);
